...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Script to download models from HuggingFace")
    parser.add_argument("-l", "--local-dir", required=True, help="Directory to download model to")
